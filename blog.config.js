...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '2791ff7d6cf28094bfebd9951b88935f',
  THEME: process.env.NEXT_PUBLIC_THEME || 'custom1', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
